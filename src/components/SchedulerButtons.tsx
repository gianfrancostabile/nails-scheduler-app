...
const SchedulerHeader = () => {
  ...
  return (
    <div className="flex justify-between align-middle">
      ...
      <button
        className="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex flex-row align-middle"
        onClick={() => displayAddEventModal()}
      >
        <svg
          className="w-5 h-5 dark:text-white mr-3"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          viewBox="0 0 20 20"
